...
def upgrade() -> None:
    ...
    op.add_column("job", sa.Column("structured_jd", postgresql.JSONB(), nullable=True))
    op.add_column(
        "job", sa.Column("structured_jd_updated_at", sa.DateTime(timezone=True), nullable=True)
    )
